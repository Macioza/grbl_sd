...
description = "ShapeOKO Grbl";
vendor = "Restrictedayerspace";
vendorUrl = "http://www.restrictedayerspace.net";
legal = "USE AT YOUR OWN PERIL";
...
properties = {
  ...
  useG28: false, // Raises Z instead of G28 before starting tool
  customZOffset: 30.0, // This is the Z offset from the work when useG28 is false
...
function toolDwell(seconds) {
   writeComment("Dwell for " + seconds + " seconds");
